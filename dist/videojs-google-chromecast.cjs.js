...
var Chromecast = /*#__PURE__*/function (_Tech) {
  _inheritsLoose(Chromecast, _Tech);
  ...
  function Chromecast(options, ready) {
    ...
    var mediaStatusUpdateHandler = _this.onMediaStatusUpdate.bind(_assertThisInitialized(_this));

    var sessionUpdateHandler = _this.onSessionUpdate.bind(_assertThisInitialized(_this));
    ...
    if (tracks) {
      var changeHandler = _this.handleTextTracksChange.bind(_assertThisInitialized(_this));
    ...
    try {
      ...
      if (tracks) {
        var _changeHandler = _this.handleAudioTracksChange.bind(_assertThisInitialized(_this));
    ...
    try {
      ...
      if (tracks) {
        var _changeHandler2 = _this.handleVideoTracksChange.bind(_assertThisInitialized(_this));
