...
(function () {
    ...
    var sb = function (a, b) {
            if (0 == a.l)
                if (a.s) {
                    var c = a.s;
                    if (c.w) {
                        for (var d = 0, e = null, f = null, k = c.w; k && (k.ca || (d++, k.F == a && (e = k), !(e && 1 < d))); k = k.next) e || (f = k);
    ...
    g.Wb = function () {
        this.j &&
        ("function" === typeof this.j.getEstimatedBreakTime && (this.g.currentBreakTime = this.j.getEstimatedBreakTime()),
        "function" === typeof this.j.getEstimatedBreakClipTime && (this.g.currentBreakTime = this.j.getEstimatedBreakClipTime()),
...
*/
    ...
    var Za = function (a, b) {
        (a = (a = b || a) && a.oc)
            ? (null != a && a.Va === Xa ? ((a = a.getContent()), (a = String(a).replace(Nb, "").replace(Ob, "&lt;")), (a = String(a).replace(Mb, Lb))) : ((a = String(a)), (a = oa(a, void 0))), (a = ' nonce="' + a + '"'))
            : (a = "");
        return Jb(
            "<style" +
            a +
    ...
    var gc = function () {
        ...
        kc = function (a, b) {
            ...
            a.fb = a.Vb.bind(a);
            a.qa = [];
            for (let c = 0; 3 > c; c++) a.qa.push(b.querySelector("#cast_caf_icon_arch" + c));
    ...
    customElements.define ? (customElements.define("google-cast-button", oc, { extends: "button" }), customElements.define("google-cast-launcher", nc)) : ("complete" !== document.readyState ? window.addEventListener("load", rc) : rc(), qc());
    u(
    ...
    var tc = function (a, b) {
        ...
        Z = class extends Db {
            ...
            D(a) {
                ...
                a
                    ? ((this.g.queueData = a.queueData), (this.g.videoInfo = a.videoInfo), (this.g.liveSeekableRange = "function" === typeof a.getEstimatedLiveSeekableRange ? a.getEstimatedLiveSeekableRange() : a.liveSeekableRange))
